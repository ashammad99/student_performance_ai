...
<div class="container">
    ...
    <p class="signup-text">ليس لديك حساب؟ <a href="teacher-register.html">إنشاء حساب جديد</a></p>
</div>
...
<script>
    const phrases = [
        "أدخل لتسجيل الملاحظات وتتبع أداء طلابك بدقة",
        "بصمتك في عقل كل طالب هي بداية لمستقبل مشرق",
        "لا يقتصر دورك على التعليم، بل على بناء قادة الغد",
        "أنتَ المهندس الذي يصنع العقول",
