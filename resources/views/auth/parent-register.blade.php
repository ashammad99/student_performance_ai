...
<div class="container">
    <img src="https://cdn-icons-png.flaticon.com/512/2922/2922522.png" alt="ولي الأمر" class="top-icon">
    <h2>تسجيل حساب ولي أمر جديد</h2>
    <form>
    ...
    <p class="signup-text">لديك حساب بالفعل؟ <a href="parent-login.html">تسجيل الدخول</a></p>
</div>
...
<script>
    const phrases = [
        "بمتابعتك، تزهرُ شجرة المعرفة في حياة طفلك.",
        "أنتَ الشريك الأول في صناعة المستقبل. بمتابعتك، تزهر قدرات طفلك.",
        "كل خطوة صغيرة من دعمك اليوم، هي قفزة كبيرة في مستقبل طفلك غداً.",
        "بين يديك مفتاح النجاح. كن القوة الدافعة خلف كل إنجاز."
    ];
