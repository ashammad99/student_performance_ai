...
<div class="container">
    ...
    <p class="signup-text">لديك حساب بالفعل؟ <a href="student-login.html">تسجيل الدخول</a></p>
</div>
...
<script>
    const phrases = [
        "كل درس اليوم هو خطوة نحو حلمك. انطلق!",
        "المعرفة قوة. كلما تعلمت أكثر، أصبحت أقوى.",
        "استمر في التعلم، فالمستقبل ينتمي للمثابرين.",
        "لا تستسلم أبداً. كل عثرة هي درس، وكل درس هو فرصة للنمو."
    ];
